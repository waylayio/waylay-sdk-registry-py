...
class PlugTagsApi(WithApiClient):
    """PlugTagsApi service methods.
    ...
    async def add_all(
        ...
        **kwargs,
        ...
        if json is not None and validate_request:
            _BodyType = Optional[UpdateTagsRequestV2]  # fmt: skip  # noqa: UP045
        ...
        return await self.api_client.request(
            method="PATCH",
            resource_path="/registry/v2/plugs/{name}/tags",
    ...
    async def add(
        ...
        **kwargs,
        ...
        return await self.api_client.request(
            method="PATCH",
            resource_path="/registry/v2/plugs/{name}/versions/{version}/tags",
            path_params=path_params,
            params=query,
            **body_args,
            headers=headers,
    ...
    async def find_all(
        ...
        **kwargs,
        ...
        return await self.api_client.request(
            method="GET",
            resource_path="/registry/v2/plugs/{name}/tags/{tagName}",
            path_params=path_params,
            params=query,
            **body_args,
            headers=headers,
    ...
    async def find(
        ...
        **kwargs,
        ...
        return await self.api_client.request(
            method="GET",
            resource_path="/registry/v2/plugs/{name}/versions/{version}/tags/{tagName}",
            path_params=path_params,
            params=query,
            **body_args,
            headers=headers,
