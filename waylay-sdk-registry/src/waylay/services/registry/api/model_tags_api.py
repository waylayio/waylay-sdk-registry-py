...
class ModelTagsApi(WithApiClient):
    """ModelTagsApi service methods.
    ...
    async def add_all(
        ...
        **kwargs,
        ...
        return await self.api_client.request(
            method="PATCH",
            resource_path="/registry/v2/models/{name}/tags",
    ...
    async def add(
        ...
        **kwargs,
        ...
        return await self.api_client.request(
            method="PATCH",
            resource_path="/registry/v2/models/{name}/versions/{version}/tags",
            path_params=path_params,
            params=query,
            **body_args,
            headers=headers,
    ...
    async def find_all(
        ...
        **kwargs,
        ...
        return await self.api_client.request(
            method="GET",
            resource_path="/registry/v2/models/{name}/tags/{tagName}",
            path_params=path_params,
            params=query,
            **body_args,
            headers=headers,
    ...
    async def find(
        ...
        **kwargs,
        ...
        return await self.api_client.request(
            method="GET",
            resource_path="/registry/v2/models/{name}/versions/{version}/tags/{tagName}",
            path_params=path_params,
            params=query,
            **body_args,
            headers=headers,
