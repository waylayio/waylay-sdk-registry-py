...
try:
    ...
    if not TYPE_CHECKING:
        ...
        GetAssetByRoleModelsAssetRoleParameter = str
...
class PlugsApi(WithApiClient):
    ...
    async def create(
        ...
        **kwargs,
        ...
        :type query['copy']: CreateModelsCopyParameter
    ...
    async def get_asset_by_role(
        ...
        **kwargs,
        ...
        :type asset_role: GetAssetByRoleModelsAssetRoleParameter
        :param query: URL Query parameters.
    ...
    async def patch_interface(
        ...
        **kwargs,
        ...
        body_args: Dict[str, Any] = {}
        if json is not None and validate_request:
            body_adapter: Any = TypeAdapter(Optional[Documentation])
            json = body_adapter.validate_python(json)  # type: ignore # https://github.com/pydantic/pydantic/discussions/7094
        body_args["json"] = json
    ...
    async def patch_manifest(
        ...
        **kwargs,
        ...
        body_args: Dict[str, Any] = {}
        if json is not None and validate_request:
            body_adapter: Any = TypeAdapter(Optional[PlugManifestPatch])
            json = body_adapter.validate_python(json)  # type: ignore # https://github.com/pydantic/pydantic/discussions/7094
        body_args["json"] = json
    ...
    async def patch_metadata(
        ...
        **kwargs,
        ...
        body_args: Dict[str, Any] = {}
        if json is not None and validate_request:
            body_adapter: Any = TypeAdapter(Optional[UpdatePlugMetadataRequestV2])
            json = body_adapter.validate_python(json)  # type: ignore # https://github.com/pydantic/pydantic/discussions/7094
        body_args["json"] = json
