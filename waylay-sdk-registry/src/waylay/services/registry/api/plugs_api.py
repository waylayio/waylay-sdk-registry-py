...
try:
    ...
    if not TYPE_CHECKING:
        ...
        GetAssetByRolePlugsAssetRole = str
        ...
        UpdatePlugMetadataRequestV2 = Model
        ...
        UpdateAssetByRolePlugsAssetRole = str
...
class PlugsApi(WithApiClient):
    ...
    async def create(
        ...
        **kwargs,
        ...
        :type query['copy']: CreatePlugsCopy
        ...
        if json is not None and validate_request:
            _BodyType = Annotated[Optional[dict[str, Any]], Field(description="The assets for a <em>plug</em> function can be provided as   <ul>     <li>A single <em>tar</em> archive (optionally compressed), with one of the content types      <code>application/octet-stream</code>, <code>application/tar</code>, <code>application/tar+gzip</code>, <code>application/x-gzip</code>, <code>application/x-tar</code>, <code>application/gzip</code></li>     <li>Separate files in a <code>multipart/form-data</code> request</li>     <li>A reference to the assets of another <em>plug</em> in the <code>copy</code> argument</li>   </ul>    The required <code>plug.json</code> json file contains the function metadata,   and must have a <code>runtime</code> attribute that is one of the supported <em>runtime</em>s    (see <code>GET /registry/v2/runtimes?functionType=plugs</code>).    For each <em>runtime</em> other files will be required or supported. ")]  # fmt: skip  # noqa: UP045
    ...
    async def get_asset_by_role(
        ...
        **kwargs,
        ...
        Get asset content or metadata from the archive of a plug by asset role.
        :param name: The name of the function. (required)
        :type name: str
        :param version: The version of the function. (required)
        :type version: str
        ...
        :type asset_role: GetAssetByRolePlugsAssetRole
        :param query: URL Query parameters.
        ...
        return await self.api_client.request(
            method="GET",
            resource_path="/registry/v2/plugs/{name}/versions/{version}/{assetRole}",
            path_params=path_params,
            params=query,
            **body_args,
            headers=headers,
    ...
    async def get_asset(
        ...
        **kwargs,
        ...
        Get asset content or metadata from the archive of a plug by name.
        :param name: The name of the function. (required)
        :type name: str
        :param version: The version of the function. (required)
        :type version: str
    ...
    async def list(
        ...
        **kwargs,
        ...
        List the (latest) versions of available <em>plugs</em>.  ### List Latest Plug Versions By default, the result includes the latest non-deprecated, non-draft version for each name, among the plug versions that satisfy the query filters. If there is no such version, the latest _deprecated_ or the latest _draft_ version is included, with the former taking precedence.     Use the boolean query parameters <code>includeDeprecated</code> or <code>includeDraft</code> to change this behaviour:   <ul>   <li><code>includeDeprecated=true</code>: do not prefer non-deprecated versions as a latest version: if the latest version is a deprecated one, it will be shown, even if there are older non-deprecated versions.</li>   <li><code>includeDraft=true</code>: do not prefer non-draft versions as a latest version: if the latest version is a draft, it will be shown, even if there are older non-draft versions.</li>   </ul>   ### Related Plug Versions Each listed _latest_ <em>plug version</em> contains HAL references to the latest _draft_  or _published_ version of the same name,  if they exist and are different from the selected _latest_ version. These linked versions might not satisfy other query filters.  Use the query parameter `showRelated` to change the representation of linked versions:  * `showRelated=link`: (default) include links (`entities[]._links.draft`,`entities[]._links.published`) * `showRelated=embed`: include  a full representation (`entities[]._embedded.draft`,`entities[]._embedded.published`) * `showRelated=none`: do not include related versions.  ### List All Plug Versions When using `latest=false` the listing contains _all_  <em>plugs</em> versions that satisfy the query, possibly multiple versions per named <em>plugs</em>. No HAL links are provided.  #### Filter on _status_ By default <em>plug versions</em> with status  `undeployed` are **excluded** in all cases. Use the _version filter_ `status` to include/exclude a status from the results. By example,  > `?status=any&includeDeprecated=true&includeDraft=true&latest=false`  will list (a page of) _ALL_ versions known to the function registry.
        :param query: URL Query parameters.
    ...
    async def patch_interface(
        ...
        **kwargs,
        ...
        body_args: dict[str, Any] = {}
        if json is not None and validate_request:
            _BodyType = Optional[Documentation]  # fmt: skip  # noqa: UP045
            body_adapter: TypeAdapter = TypeAdapter(_BodyType)
            json = body_adapter.validate_python(json)  # type: ignore # https://github.com/pydantic/pydantic/discussions/7094
        body_args["json"] = json
    ...
    async def patch_manifest(
        ...
        *,
        json: PlugManifestPatch | None = None,
    ...
    async def patch_manifest(
        ...
        **kwargs,
        ...
        The provided json content will be merged with the existing as <code>plug.json</code> manifest asset.   Please note that it is not allowed to change the any of the <code>name</code>, <code>version</code> and/or <code>runtime</code> attributes.
        :param name: The name of the function. (required)
        :type name: str
        :param version: The version of the function. (required)
        :type version: str
        :param json: The json request body.
        :type json: PlugManifestPatch, optional
        :param query: URL Query parameters.
        ...
        body_args: dict[str, Any] = {}
        if json is not None and validate_request:
            _BodyType = Optional[PlugManifestPatch]  # fmt: skip  # noqa: UP045
            body_adapter: TypeAdapter = TypeAdapter(_BodyType)
            json = body_adapter.validate_python(json)  # type: ignore # https://github.com/pydantic/pydantic/discussions/7094
        body_args["json"] = json
        ...
        return await self.api_client.request(
            method="PATCH",
            resource_path="/registry/v2/plugs/{name}/versions/{version}/manifest",
            path_params=path_params,
            params=query,
            **body_args,
            headers=headers,
    ...
    async def patch_metadata(
        ...
        *,
        json: UpdatePlugMetadataRequestV2 | None = None,
    ...
    async def patch_metadata(
        ...
        **kwargs,
        ...
        :type version: str
        :param json: The json request body.
        :type json: UpdatePlugMetadataRequestV2, optional
        :param query: URL Query parameters.
        ...
        body_args: dict[str, Any] = {}
        if json is not None and validate_request:
            _BodyType = Optional[UpdatePlugMetadataRequestV2]  # fmt: skip  # noqa: UP045
            body_adapter: TypeAdapter = TypeAdapter(_BodyType)
            json = body_adapter.validate_python(json)  # type: ignore # https://github.com/pydantic/pydantic/discussions/7094
        body_args["json"] = json
    ...
    async def protect(
        ...
        **kwargs,
        ...
        return await self.api_client.request(
            method="POST",
            resource_path="/registry/v2/plugs/{name}/versions/{version}/protect",
            path_params=path_params,
            params=query,
            **body_args,
            headers=headers,
    ...
    async def protect_versions(
        ...
        **kwargs,
        ...
        return await self.api_client.request(
            method="POST",
            resource_path="/registry/v2/plugs/{name}/protect",
            path_params=path_params,
            params=query,
            **body_args,
            headers=headers,
    ...
    async def update_asset(
        ...
        **kwargs,
        ...
        The provided asset will be added to the <em>plug</em> function's collection of existing assets,   replacing any existing asset with the same _name_.    Please note that it is not allowed to update the    <code>plug.json</code>    json file with a changed value for any of the  <code>name</code>, <code>version</code> and/or <code>runtime</code> attributes.   For each <em>runtime</em> other files are supported.
        :param name: The name of the function. (required)
        :type name: str
        :param version: The version of the function. (required)
        :type version: str
