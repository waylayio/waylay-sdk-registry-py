...
try:
    ...
    if not TYPE_CHECKING:
        ...
        GetAssetByRoleWebscriptsAssetRole = str
        ...
        UpdateAssetByRoleWebscriptsAssetRole = str
...
class WebscriptsApi(WithApiClient):
    ...
    async def create(
        ...
        *,
        ...
        headers: HeaderTypes | None = None,
        **kwargs,
    ) -> PostWebscriptJobSyncResponseV2 | PostWebscriptJobAsyncResponseV2 | T | Response | Model:
        """Create Version.
        ...
        :type query['copy']: CreateWebscriptsCopy
        ...
        if json is not None and validate_request:
            _BodyType = Annotated[Optional[dict[str, Any]], Field(description="The assets for a <em>webscript</em> function can be provided as   <ul>     <li>A single <em>tar</em> archive (optionally compressed), with one of the content types      <code>application/octet-stream</code>, <code>application/tar</code>, <code>application/tar+gzip</code>, <code>application/x-gzip</code>, <code>application/x-tar</code>, <code>application/gzip</code></li>     <li>Separate files in a <code>multipart/form-data</code> request</li>     <li>A reference to the assets of another <em>webscript</em> in the <code>copy</code> argument</li>   </ul>    The required <code>webscript.json</code> json file contains the function metadata,   and must have a <code>runtime</code> attribute that is one of the supported <em>runtime</em>s    (see <code>GET /registry/v2/runtimes?functionType=webscripts</code>).    For each <em>runtime</em> other files will be required or supported. ")]  # fmt: skip  # noqa: UP045
    ...
    async def get_asset_by_role(
        ...
        **kwargs,
        ...
        :type asset_role: GetAssetByRoleWebscriptsAssetRole
        :param query: URL Query parameters.
        ...
        return await self.api_client.request(
            method="GET",
            resource_path="/registry/v2/webscripts/{name}/versions/{version}/{assetRole}",
            path_params=path_params,
            params=query,
            **body_args,
            headers=headers,
    ...
    async def patch_manifest(
        ...
        *,
        json: WebscriptManifestPatch | None = None,
    ...
    async def patch_manifest(
        ...
        *,
        ...
        headers: HeaderTypes | None = None,
        **kwargs,
    ) -> PostWebscriptJobAsyncResponseV2 | PostWebscriptJobSyncResponseV2 | T | Response | Model:
        """Patch Manifest.
        ...
        :type json: WebscriptManifestPatch, optional
        :param query: URL Query parameters.
        ...
        body_args: dict[str, Any] = {}
        if json is not None and validate_request:
            _BodyType = Optional[WebscriptManifestPatch]  # fmt: skip  # noqa: UP045
            body_adapter: TypeAdapter = TypeAdapter(_BodyType)
            json = body_adapter.validate_python(json)  # type: ignore # https://github.com/pydantic/pydantic/discussions/7094
        body_args["json"] = json
        ...
        response_types_map: dict[str, Any] = (
            ...
            if response_type is not None
                ...
                "201": PostWebscriptJobAsyncResponseV2 if not select_path else Model,
                "202": PostWebscriptJobSyncResponseV2 if not select_path else Model,
            }
        )
        non_200_response_types_map: dict[str, Any] = {
            "403": RegistryErrorResponse,
        ...
        return await self.api_client.request(
            method="PATCH",
            resource_path="/registry/v2/webscripts/{name}/versions/{version}/manifest",
            path_params=path_params,
            params=query,
            **body_args,
            headers=headers,
    ...
    async def protect_versions(
        ...
        **kwargs,
        ...
        return await self.api_client.request(
            method="POST",
            resource_path="/registry/v2/webscripts/{name}/protect",
            path_params=path_params,
            params=query,
            **body_args,
            headers=headers,
    ...
    async def protect(
        ...
        **kwargs,
        ...
        return await self.api_client.request(
            method="POST",
            resource_path="/registry/v2/webscripts/{name}/versions/{version}/protect",
            path_params=path_params,
            params=query,
            **body_args,
            headers=headers,
    ...
    async def rebuild(
        ...
        *,
        ...
        headers: HeaderTypes | None = None,
        **kwargs,
    ) -> RebuildWebscriptSyncResponseV2 | RebuildWebscriptAsyncResponseV2 | T | Response | Model:
        """Rebuild.
    ...
    async def update_asset_by_role(
        ...
        **kwargs,
        ...
        :type version: str
        :param asset_role: Role name of the asset. The mapping to a concrete asset path depends on the runtime. Only asset roles with a fixed asset path for the runtime are supported. (required)
        :type asset_role: UpdateAssetByRoleWebscriptsAssetRole
    ...
    async def verify(
        ...
        *,
        ...
        headers: HeaderTypes | None = None,
        **kwargs,
    ) -> VerifyWebscriptSyncResponseV2 | PostWebscriptJobAsyncResponseV2 | T | Response | Model:
        """Verify Health.
