...
try:
    ...
    if not TYPE_CHECKING:
        ...
        GetAssetByRoleModelsAssetRole = str
        GetAssetByRoleQuery = dict
        ...
        IKFServingManifestPatch = Model

        PatchManifestQuery = dict
        PostModelJobAsyncResponseV2 = Model
        ...
        UpdateAssetByRoleModelsAssetRole = str
        UpdateAssetByRoleQuery = dict
        PostModelJobAsyncResponseV2 = Model
...
class ModelsApi(WithApiClient):
    ...
    async def create(
        ...
        **kwargs,
        ...
        :param query['deprecatePrevious'] (dict) <br> query.deprecate_previous (Query) : Set the cleanup policy used to automatically deprecate/delete previous versions when creating a new non-draft version or publishing a draft version.
        ...
        :type query['copy']: CreateModelsCopy
        ...
        if json is not None and validate_request:
            _BodyType = Annotated[Optional[dict[str, Any]], Field(description="The assets for a <em>model</em> function can be provided as   <ul>     <li>A single <em>tar</em> archive (optionally compressed), with one of the content types      <code>application/octet-stream</code>, <code>application/tar</code>, <code>application/tar+gzip</code>, <code>application/x-gzip</code>, <code>application/x-tar</code>, <code>application/gzip</code></li>     <li>Separate files in a <code>multipart/form-data</code> request</li>     <li>A reference to the assets of another <em>model</em> in the <code>copy</code> argument</li>   </ul>    The required <code>model.json</code> json file contains the function metadata,   and must have a <code>runtime</code> attribute that is one of the supported <em>runtime</em>s    (see <code>GET /registry/v2/runtimes?functionType=kfserving</code>).    For each <em>runtime</em> other files will be required or supported. ")]  # fmt: skip  # noqa: UP045
    ...
    async def get_asset_by_role(
        ...
        *,
        query: GetAssetByRoleQuery | QueryParamTypes | None = None,
        raw_response: Literal[False] = False,
        select_path: Literal[""] = "",
        response_type: Literal[None] = None,
        validate_request: StrictBool = True,
    ...
    async def get_asset_by_role(
        ...
        **kwargs,
        ...
        :param version: The version of the function. (required)
        :type version: str
        :param asset_role: Role name of the asset. The mapping to a concrete asset path depends on the runtime. Only asset roles with a fixed asset path for the runtime are supported. (required)
        :type asset_role: GetAssetByRoleModelsAssetRole
        :param query: URL Query parameters.
        :type query: GetAssetByRoleQuery | QueryParamTypes, optional
        :param query['ls'] (dict) <br> query.ls (Query) : If set to `true`, the result will be a listing of the files in the asset, annotated with metadata and validation report from the asset conditions of the functions runtime.
        :type query['ls']: bool
        :param raw_response: If true, return the http Response object instead of returning an api model object, or throwing an ApiError.
        :param select_path: Denotes the json path applied to the response object before returning it.
        ...
        # query parameters
        if query is not None and MODELS_AVAILABLE and validate_request:
            query = TypeAdapter(GetAssetByRoleQuery).validate_python(query)
        ...
        return await self.api_client.request(
            method="GET",
            resource_path="/registry/v2/models/{name}/versions/{version}/{assetRole}",
            path_params=path_params,
            params=query,
            **body_args,
            headers=headers,
    ...
    async def get_latest(
        ...
        **kwargs,
        ...
        :param query['showTags'] (dict) <br> query.show_tags (Query) : Instructs how tag (objects) should be rendered in responses. The tags are show at the `tags` property of the manifest (legacy: the `metadata.tags` property) - `inline`: Show full tag objects in the manifest. - `embed`: Show tag references in the manifest.          Referenced full tag objects are included in a separate `_embedded` HAL section. - `none`: Show tag references in the manifest. Do not render tag objects.  The default behaviour depends on deployment settings.
        :type query['showTags']: ShowInlineOrEmbedding
        :param query['includeDraft'] (dict) <br> query.include_draft (Query) : Configures the inclusion of _draft_ versions when selecting latest versions per name. By default, draft versions are only considered when no other versions are available. If set to `true`, draft versions can be selected as latest version. If set to `false`, draft versions are **excluded**. (similar to a `draft=false` filter)
    ...
    async def list(
        ...
        **kwargs,
        ...
        :param query['latest'] (dict) <br> query.latest (Query) : When `true`, only the latest version per function name is returned. If set to `false`, multiple versions per named function can be returned. Defaults to `true`.
    ...
    async def patch_manifest(
        ...
        *,
        json: IKFServingManifestPatch | None = None,
        query: PatchManifestQuery | QueryParamTypes | None = None,
        raw_response: Literal[False] = False,
        select_path: Literal[""] = "",
        response_type: Literal[None] = None,
        validate_request: StrictBool = True,
    ...
    async def patch_manifest(
        ...
        *,
        ...
        headers: HeaderTypes | None = None,
        **kwargs,
    ) -> PostModelJobAsyncResponseV2 | PostModelJobSyncResponseV2 | T | Response | Model:
        """Patch Manifest.
        ...
        :type json: IKFServingManifestPatch, optional
        :param query: URL Query parameters.
        :type query: PatchManifestQuery | QueryParamTypes, optional
        :param query['showTags'] (dict) <br> query.show_tags (Query) : Instructs how tag (objects) should be rendered in responses. The tags are show at the `tags` property of the manifest (legacy: the `metadata.tags` property) - `inline`: Show full tag objects in the manifest. - `embed`: Show tag references in the manifest.          Referenced full tag objects are included in a separate `_embedded` HAL section. - `none`: Show tag references in the manifest. Do not render tag objects.  The default behaviour depends on deployment settings.
        :type query['showTags']: ShowInlineOrEmbedding
        :param query['scaleToZero'] (dict) <br> query.scale_to_zero (Query) : If set to <code>true</code>, after successful deployment, the deployed function will be scaled to zero. This saves computing resources when the function is not to be used immediately.
        :type query['scaleToZero']: bool
        ...
        body_args: dict[str, Any] = {}
        if json is not None and validate_request:
            _BodyType = Optional[IKFServingManifestPatch]  # fmt: skip  # noqa: UP045
            body_adapter: TypeAdapter = TypeAdapter(_BodyType)
            json = body_adapter.validate_python(json)  # type: ignore # https://github.com/pydantic/pydantic/discussions/7094
        body_args["json"] = json
        ...
        # query parameters
        if query is not None and MODELS_AVAILABLE and validate_request:
            query = TypeAdapter(PatchManifestQuery).validate_python(query)

        response_types_map: dict[str, Any] = (
            {"2XX": response_type}
            if response_type is not None
            else {
                "201": PostModelJobAsyncResponseV2 if not select_path else Model,
                "202": PostModelJobSyncResponseV2 if not select_path else Model,
            }
        )
        non_200_response_types_map: dict[str, Any] = {
            "403": RegistryErrorResponse,
        ...
        return await self.api_client.request(
            method="PATCH",
            resource_path="/registry/v2/models/{name}/versions/{version}/manifest",
            path_params=path_params,
            params=query,
            **body_args,
            headers=headers,
    ...
    async def patch_metadata(
        ...
        **kwargs,
        ...
        body_args: dict[str, Any] = {}
        if json is not None and validate_request:
            _BodyType = Optional[UpdateMetadataRequestV2]  # fmt: skip  # noqa: UP045
            body_adapter: TypeAdapter = TypeAdapter(_BodyType)
            json = body_adapter.validate_python(json)  # type: ignore # https://github.com/pydantic/pydantic/discussions/7094
        body_args["json"] = json
    ...
    async def rebuild(
        ...
        **kwargs,
        ...
        :param query['forceDeploy'] (dict) <br> query.force_deploy (Query) : By default, a redeploy is skipped if there are no build/deploy argument changes. If this flag is set, a redeployment is forced in that case (with the unchanged build and deploy arguments).
        :type query['forceDeploy']: bool
        ...
        body_args: dict[str, Any] = {}
        if json is not None and validate_request:
            _BodyType = Optional[RebuildRequestV2]  # fmt: skip  # noqa: UP045
            body_adapter: TypeAdapter = TypeAdapter(_BodyType)
            json = body_adapter.validate_python(json)  # type: ignore # https://github.com/pydantic/pydantic/discussions/7094
        body_args["json"] = json
    ...
    @overload
    async def update_asset_by_role(
        self,
        name: Annotated[StrictStr, Field(description="The name of the function.")],
        version: Annotated[
            str, Field(strict=True, description="The version of the function.")
        ...
        *,
        ...
        query: UpdateAssetByRoleQuery | QueryParamTypes | None = None,
        raw_response: Literal[False] = False,
        select_path: Literal[""] = "",
        response_type: Literal[None] = None,
        validate_request: StrictBool = True,
    ...
    async def update_asset_by_role(
        ...
        **kwargs,
        ...
        :type version: str
        :param asset_role: Role name of the asset. The mapping to a concrete asset path depends on the runtime. Only asset roles with a fixed asset path for the runtime are supported. (required)
        :type asset_role: UpdateAssetByRoleModelsAssetRole
        :param content: A single asset file.
        :type content: ContentRequest, optional
        :param query: URL Query parameters.
        :type query: UpdateAssetByRoleQuery | QueryParamTypes, optional
        :param query['showTags'] (dict) <br> query.show_tags (Query) : Instructs how tag (objects) should be rendered in responses. The tags are show at the `tags` property of the manifest (legacy: the `metadata.tags` property) - `inline`: Show full tag objects in the manifest. - `embed`: Show tag references in the manifest.          Referenced full tag objects are included in a separate `_embedded` HAL section. - `none`: Show tag references in the manifest. Do not render tag objects.  The default behaviour depends on deployment settings.
        :type query['showTags']: ShowInlineOrEmbedding
        :param query['scaleToZero'] (dict) <br> query.scale_to_zero (Query) : If set to <code>true</code>, after successful deployment, the deployed function will be scaled to zero. This saves computing resources when the function is not to be used immediately.
        :type query['scaleToZero']: bool
        ...
        # query parameters
        if query is not None and MODELS_AVAILABLE and validate_request:
            query = TypeAdapter(UpdateAssetByRoleQuery).validate_python(query)
