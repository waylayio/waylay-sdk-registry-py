...
from ..types.get_latest_runtimes_tags_stub import GetLatestRuntimesTagsStub
from ..types.list_runtimes_tags_stub import ListRuntimesTagsStub
from ..types.list_versions_runtimes_tags_stub import ListVersionsRuntimesTagsStub
...
async def test_get_latest(
    ...
    kwargs = {
        ...
        "query": GetLatestQuery(
            ...
            tags=GetLatestRuntimesTagsStub.create_json(),
...
async def test_list(service: RegistryService, gateway_url: str, httpx_mock: HTTPXMock):
    ...
    kwargs = {
        ...
        "query": ListQuery(
            ...
            latest="major",
            include_deprecated=False,
            tags=ListRuntimesTagsStub.create_json(),
            name="node*",
            function_type=[FunctionTypeFilterStub.create_json()],
            archive_format=[ArchiveFormatFilterStub.create_json()],
        ),
...
async def test_list_versions(
    ...
    kwargs = {
        ...
        "query": ListVersionsQuery(
            ...
            latest="major",
            include_deprecated=False,
            tags=ListVersionsRuntimesTagsStub.create_json(),
            function_type=[FunctionTypeFilterStub.create_json()],
            archive_format=[ArchiveFormatFilterStub.create_json()],
            show_tags="embed",
        ),
