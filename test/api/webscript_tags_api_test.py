...
from waylay.services.registry.api import WebscriptTagsApi
...
@pytest.fixture
def webscript_tags_api(waylay_api_client: ApiClient) -> WebscriptTagsApi:
    return WebscriptTagsApi(waylay_api_client)


def test_registered(waylay_client: WaylayClient):
    """Test that WebscriptTagsApi api is registered in the sdk client."""
    assert isinstance(waylay_client.registry.webscript_tags, WebscriptTagsApi)
...
def _add_all_set_mock_response(httpx_mock: HTTPXMock, gateway_url: str, name: str):
    ...
    httpx_mock_kwargs = {
        "method": "PATCH",
        "url": re.compile(f"^{gateway_url}/registry/v2/webscripts/{name}/tags(\\?.*)?"),
...
async def test_add_all(
    ...
    resp = await service.webscript_tags.add_all(name, **kwargs)
...
def _add_set_mock_response(
    ...
    httpx_mock_kwargs = {
        "method": "PATCH",
        "url": re.compile(
            f"^{gateway_url}/registry/v2/webscripts/{name}/versions/{version}/tags(\\?.*)?"
        ),
        "content": json.dumps(mock_response, default=str),
        "status_code": 200,
    }
...
async def test_add(service: RegistryService, gateway_url: str, httpx_mock: HTTPXMock):
    ...
    resp = await service.webscript_tags.add(name, version, **kwargs)
    check_type(resp, FunctionTagsResponse)
...
async def test_clear_all(
    ...
    resp = await service.webscript_tags.clear_all(name, **kwargs)
    check_type(resp, FunctionTagsResponse)
...
async def test_clear(service: RegistryService, gateway_url: str, httpx_mock: HTTPXMock):
    ...
    resp = await service.webscript_tags.clear(name, version, **kwargs)
    check_type(resp, FunctionTagsResponse)
...
def _find_all_set_mock_response(
    ...
    httpx_mock_kwargs = {
        "method": "GET",
        "url": re.compile(
            f"^{gateway_url}/registry/v2/webscripts/{name}/tags/{tagName}(\\?.*)?"
        ),
        "content": json.dumps(mock_response, default=str),
        "status_code": 200,
    }
...
async def test_find_all(
    ...
    resp = await service.webscript_tags.find_all(tagName, name, **kwargs)
...
def _find_set_mock_response(
    ...
    httpx_mock_kwargs = {
        "method": "GET",
        "url": re.compile(
            f"^{gateway_url}/registry/v2/webscripts/{name}/versions/{version}/tags/{tagName}(\\?.*)?"
        ),
        "content": json.dumps(mock_response, default=str),
        "status_code": 200,
    }
...
async def test_find(service: RegistryService, gateway_url: str, httpx_mock: HTTPXMock):
    ...
    resp = await service.webscript_tags.find(tagName, name, version, **kwargs)
    check_type(resp, FunctionTagResponse)
...
async def test_list_all(
    ...
    resp = await service.webscript_tags.list_all(name, **kwargs)
    check_type(resp, FunctionTagsResponse)
...
async def test_list(service: RegistryService, gateway_url: str, httpx_mock: HTTPXMock):
    ...
    resp = await service.webscript_tags.list(name, version, **kwargs)
    check_type(resp, FunctionTagsResponse)
...
async def test_put_all(
    ...
    resp = await service.webscript_tags.put_all(tagName, name, **kwargs)
    check_type(resp, FunctionTagResponse)
...
async def test_put(service: RegistryService, gateway_url: str, httpx_mock: HTTPXMock):
    ...
    resp = await service.webscript_tags.put(tagName, name, version, **kwargs)
    check_type(resp, FunctionTagResponse)
...
async def test_remove_all(
    ...
    resp = await service.webscript_tags.remove_all(tagName, name, **kwargs)
    check_type(resp, FunctionTagResponse)
...
async def test_remove(
    ...
    resp = await service.webscript_tags.remove(tagName, name, version, **kwargs)
    check_type(resp, FunctionTagResponse)
...
async def test_replace_all(
    ...
    resp = await service.webscript_tags.replace_all(name, **kwargs)
    check_type(resp, FunctionTagsResponse)
...
async def test_replace(
    ...
    resp = await service.webscript_tags.replace(name, version, **kwargs)
    check_type(resp, FunctionTagsResponse)
