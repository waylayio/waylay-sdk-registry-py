...
from ..types.create_plugs_copy_stub import CreatePlugsCopyStub
...
from ..types.get_asset_by_role_plugs_asset_role_stub import (
    GetAssetByRolePlugsAssetRoleStub,
)
...
from ..types.update_asset_by_role_plugs_asset_role_stub import (
    UpdateAssetByRolePlugsAssetRoleStub,
)
...
MODELS_AVAILABLE = (
    find_spec("waylay.services.registry.models") is not None
)
...
async def test_create(
    ...
    kwargs = {
        ...
        "query": CreateQuery(
            ...
            copy_from=CreatePlugsCopyStub.create_json(),
        ),
        "json": None,
...
async def test_create_without_types(
    ...
    kwargs = {
        "query": {
            ...
            "draft": False,
            "runtime": "runtime_example",
            "copy": CreatePlugsCopyStub.create_json(),
        },
        "files": {
            "myFile1": b"...first file content...",
            "myFile2": b"...second file content...",
...
async def test_get_asset_by_role(
    ...
    assetRole = GetAssetByRolePlugsAssetRoleStub.create_json()
...
async def test_update_asset_by_role(
    ...
    assetRole = UpdateAssetByRolePlugsAssetRoleStub.create_json()
