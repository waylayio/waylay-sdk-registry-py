...
from ..types.create_webscripts_copy_stub import CreateWebscriptsCopyStub
from ..types.deprecate_previous_policy_stub import DeprecatePreviousPolicyStub
from ..types.get_asset_by_role_webscripts_asset_role_stub import (
    GetAssetByRoleWebscriptsAssetRoleStub,
)
...
from ..types.update_asset_by_role_webscripts_asset_role_stub import (
    UpdateAssetByRoleWebscriptsAssetRoleStub,
)
...
async def test_create(
    ...
    kwargs = {
        ...
        "query": CreateQuery(
            ...
            copy_from=CreateWebscriptsCopyStub.create_json(),
        ),
        "json": None,
...
async def test_create_without_types(
    ...
    kwargs = {
        "query": {
            ...
            "draft": False,
            "runtime": "runtime_example",
            "copy": CreateWebscriptsCopyStub.create_json(),
        },
        "files": {
            "myFile1": b"...first file content...",
            "myFile2": b"...second file content...",
...
async def test_get_asset_by_role(
    ...
    assetRole = GetAssetByRoleWebscriptsAssetRoleStub.create_json()
...
async def test_update_asset_by_role(
    ...
    assetRole = UpdateAssetByRoleWebscriptsAssetRoleStub.create_json()
