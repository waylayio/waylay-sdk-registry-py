...
from ..types.create_models_copy_stub import CreateModelsCopyStub
from ..types.deprecate_previous_policy_stub import DeprecatePreviousPolicyStub
from ..types.get_asset_by_role_models_asset_role_stub import (
    GetAssetByRoleModelsAssetRoleStub,
)
from ..types.get_model_response_v2_stub import GetModelResponseV2Stub
from ..types.ikf_serving_manifest_patch_stub import IKFServingManifestPatchStub
...
from ..types.update_asset_by_role_models_asset_role_stub import (
    UpdateAssetByRoleModelsAssetRoleStub,
)
...
async def test_create(
    ...
    kwargs = {
        ...
        "query": CreateQuery(
            ...
            copy_from=CreateModelsCopyStub.create_json(),
        ),
        "json": None,
...
async def test_create_without_types(
    ...
    kwargs = {
        "query": {
            ...
            "draft": False,
            "runtime": "runtime_example",
            "copy": CreateModelsCopyStub.create_json(),
        },
        "files": {
            "myFile1": b"...first file content...",
            "myFile2": b"...second file content...",
...
async def test_get_asset_by_role(
    ...
    assetRole = GetAssetByRoleModelsAssetRoleStub.create_json()
...
async def test_patch_manifest(
    ...
    kwargs = {
        ...
        "json": IKFServingManifestPatchStub.create_instance(),
    }
...
async def test_patch_manifest_without_types(
    ...
    kwargs = {
        ...
        "json": IKFServingManifestPatchStub.create_json(),
    }
    _patch_manifest_set_mock_response(
        httpx_mock, gateway_url, quote(str(name)), quote(str(version))
    )
...
async def test_update_asset_by_role(
    ...
    assetRole = UpdateAssetByRoleModelsAssetRoleStub.create_json()
