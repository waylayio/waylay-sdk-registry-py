...
with_entity_attributes_faker = JSF(
    with_entity_attributes_model_schema, allow_none_optionals=1
)


class WithEntityAttributesStub:
    """WithEntityAttributes unit test stubs."""

    @classmethod
    def create_json(cls):
        """Create a dict stub instance."""
        return with_entity_attributes_faker.generate(
            use_defaults=True, use_examples=True
        )

    @classmethod
    def create_instance(cls) -> "WithEntityAttributes":
        ...
        if not json:
            ...
            backup_faker = JSF(
                WithEntityAttributesAdapter.json_schema(), allow_none_optionals=1
            )
            json = backup_faker.generate(use_defaults=True, use_examples=True)
        return WithEntityAttributesAdapter.validate_python(
