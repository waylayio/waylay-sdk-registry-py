...
class PlugPropertyFormatStub:
    ...
    def create_json(cls):
        ...
        return plug_property_format_faker.generate(use_defaults=True, use_examples=True)
    ...
    def create_instance(cls) -> "PlugPropertyFormat":
        ...
        if json is None:
            ...
            backup_faker = JSF(
                PlugPropertyFormatAdapter.json_schema(), allow_none_optionals=1
            )
            json = backup_faker.generate(use_defaults=True, use_examples=True)
        return PlugPropertyFormatAdapter.validate_python(
