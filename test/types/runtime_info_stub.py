...
class RuntimeInfoStub:
    ...
    def create_json(cls):
        ...
        return runtime_info_faker.generate(use_defaults=True, use_examples=True)
    ...
    def create_instance(cls) -> "RuntimeInfo":
        ...
        if not json:
            ...
            backup_faker = JSF(RuntimeInfoAdapter.json_schema(), allow_none_optionals=1)
            json = backup_faker.generate(use_defaults=True, use_examples=True)
        return RuntimeInfoAdapter.validate_python(
