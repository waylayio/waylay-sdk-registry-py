...
class JobStateStub:
    ...
    def create_json(cls):
        ...
        return job_state_faker.generate(use_defaults=True, use_examples=True)
    ...
    def create_instance(cls) -> "JobState":
        ...
        if json is None:
            ...
            backup_faker = JSF(JobStateAdapter.json_schema(), allow_none_optionals=1)
            json = backup_faker.generate(use_defaults=True, use_examples=True)
        return JobStateAdapter.validate_python(json, context={"skip_validation": True})
