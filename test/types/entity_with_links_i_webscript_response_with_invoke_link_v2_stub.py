...
try:
    ...
    warnings.warn(
        f"Type adapter for EntityWithLinksIWebscriptResponseWithInvokeLinkV2 not available: {exc}"
    )
    MODELS_AVAILABLE = False

entity_with_links_i_webscript_response_with_invoke_link_v2__model_schema = json.loads(r"""{
