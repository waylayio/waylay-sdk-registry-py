...
class VersionIncludesStub:
    ...
    def create_json(cls):
        ...
        return version_includes_faker.generate(use_defaults=True, use_examples=True)
    ...
    def create_instance(cls) -> "VersionIncludes":
        ...
        if not json:
            ...
            backup_faker = JSF(
                VersionIncludesAdapter.json_schema(), allow_none_optionals=1
            )
            json = backup_faker.generate(use_defaults=True, use_examples=True)
        return VersionIncludesAdapter.validate_python(
