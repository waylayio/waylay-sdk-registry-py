...
class SchemaParamsStub:
    ...
    def create_json(cls):
        ...
        return schema_params_faker.generate(use_defaults=True, use_examples=True)
    ...
    def create_instance(cls) -> "SchemaParams":
        ...
        if not json:
            ...
            backup_faker = JSF(
                SchemaParamsAdapter.json_schema(), allow_none_optionals=1
            )
            json = backup_faker.generate(use_defaults=True, use_examples=True)
        return SchemaParamsAdapter.validate_python(
