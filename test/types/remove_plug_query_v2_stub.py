...
class RemovePlugQueryV2Stub:
    ...
    def create_json(cls):
        ...
        return remove_plug_query_v2_faker.generate(use_defaults=True, use_examples=True)
    ...
    def create_instance(cls) -> "RemovePlugQueryV2":
        ...
        if not json:
            ...
            backup_faker = JSF(
                RemovePlugQueryV2Adapter.json_schema(), allow_none_optionals=1
            )
            json = backup_faker.generate(use_defaults=True, use_examples=True)
        return RemovePlugQueryV2Adapter.validate_python(
