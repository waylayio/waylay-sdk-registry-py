...
class EventWithCloseSSEStub:
    ...
    def create_json(cls):
        ...
        return event_with_close_sse_faker.generate(use_defaults=True, use_examples=True)
    ...
    def create_instance(cls) -> "EventWithCloseSSE":
        ...
        if json is None:
            ...
            backup_faker = JSF(
                EventWithCloseSSEAdapter.json_schema(), allow_none_optionals=1
            )
            json = backup_faker.generate(use_defaults=True, use_examples=True)
        return EventWithCloseSSEAdapter.validate_python(
