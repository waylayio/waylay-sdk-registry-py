...
class AnyJobStatusStub:
    ...
    def create_json(cls):
        ...
        return any_job_status_faker.generate(use_defaults=True, use_examples=True)
    ...
    def create_instance(cls) -> "AnyJobStatus":
        ...
        if json is None:
            ...
            backup_faker = JSF(
                AnyJobStatusAdapter.json_schema(), allow_none_optionals=1
            )
            json = backup_faker.generate(use_defaults=True, use_examples=True)
        return AnyJobStatusAdapter.validate_python(
