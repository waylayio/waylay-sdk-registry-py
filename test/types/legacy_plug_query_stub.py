...
class LegacyPlugQueryStub:
    ...
    def create_json(cls):
        ...
        return legacy_plug_query_faker.generate(use_defaults=True, use_examples=True)
    ...
    def create_instance(cls) -> "LegacyPlugQuery":
        ...
        if not json:
            ...
            backup_faker = JSF(
                LegacyPlugQueryAdapter.json_schema(), allow_none_optionals=1
            )
            json = backup_faker.generate(use_defaults=True, use_examples=True)
        return LegacyPlugQueryAdapter.validate_python(
