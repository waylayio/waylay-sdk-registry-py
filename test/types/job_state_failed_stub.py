...
class JobStateFailedStub:
    ...
    def create_json(cls):
        ...
        return job_state_failed_faker.generate(use_defaults=True, use_examples=True)
    ...
    def create_instance(cls) -> "JobStateFailed":
        ...
        if json is None:
            ...
            backup_faker = JSF(
                JobStateFailedAdapter.json_schema(), allow_none_optionals=1
            )
            json = backup_faker.generate(use_defaults=True, use_examples=True)
        return JobStateFailedAdapter.validate_python(
