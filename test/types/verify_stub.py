...
class VerifyStub:
    ...
    def create_json(cls):
        ...
        return verify_faker.generate(use_defaults=True, use_examples=True)
    ...
    def create_instance(cls) -> "Verify":
        ...
        if json is None:
            ...
            backup_faker = JSF(VerifyAdapter.json_schema(), allow_none_optionals=1)
            json = backup_faker.generate(use_defaults=True, use_examples=True)
        return VerifyAdapter.validate_python(json, context={"skip_validation": True})
