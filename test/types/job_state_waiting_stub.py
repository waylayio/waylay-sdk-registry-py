...
class JobStateWaitingStub:
    ...
    def create_json(cls):
        ...
        return job_state_waiting_faker.generate(use_defaults=True, use_examples=True)
    ...
    def create_instance(cls) -> "JobStateWaiting":
        ...
        if json is None:
            ...
            backup_faker = JSF(
                JobStateWaitingAdapter.json_schema(), allow_none_optionals=1
            )
            json = backup_faker.generate(use_defaults=True, use_examples=True)
        return JobStateWaitingAdapter.validate_python(
