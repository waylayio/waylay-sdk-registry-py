...
class JobStateFinishedStub:
    ...
    def create_json(cls):
        ...
        return job_state_finished_faker.generate(use_defaults=True, use_examples=True)
    ...
    def create_instance(cls) -> "JobStateFinished":
        ...
        if json is None:
            ...
            backup_faker = JSF(
                JobStateFinishedAdapter.json_schema(), allow_none_optionals=1
            )
            json = backup_faker.generate(use_defaults=True, use_examples=True)
        return JobStateFinishedAdapter.validate_python(
