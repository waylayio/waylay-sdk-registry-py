...
class AnyJobResultStub:
    ...
    def create_json(cls):
        ...
        return any_job_result_faker.generate(use_defaults=True, use_examples=True)
    ...
    def create_instance(cls) -> "AnyJobResult":
        ...
        if json is None:
            ...
            backup_faker = JSF(
                AnyJobResultAdapter.json_schema(), allow_none_optionals=1
            )
            json = backup_faker.generate(use_defaults=True, use_examples=True)
        return AnyJobResultAdapter.validate_python(
