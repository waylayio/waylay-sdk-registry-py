...
class WaitingEventDataStub:
    ...
    def create_json(cls):
        ...
        return waiting_event_data_faker.generate(use_defaults=True, use_examples=True)
    ...
    def create_instance(cls) -> "WaitingEventData":
        ...
        if json is None:
            ...
            backup_faker = JSF(
                WaitingEventDataAdapter.json_schema(), allow_none_optionals=1
            )
            json = backup_faker.generate(use_defaults=True, use_examples=True)
        return WaitingEventDataAdapter.validate_python(
