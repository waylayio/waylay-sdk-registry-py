...
class PlugDeleteQueryStub:
    ...
    def create_json(cls):
        ...
        return plug_delete_query_faker.generate(use_defaults=True, use_examples=True)
    ...
    def create_instance(cls) -> "PlugDeleteQuery":
        ...
        if not json:
            ...
            backup_faker = JSF(
                PlugDeleteQueryAdapter.json_schema(), allow_none_optionals=1
            )
            json = backup_faker.generate(use_defaults=True, use_examples=True)
        return PlugDeleteQueryAdapter.validate_python(
