...
named_plug_versions_query_v2_faker = JSF(
    named_plug_versions_query_v2_model_schema, allow_none_optionals=1
)
...
class NamedPlugVersionsQueryV2Stub:
    ...
    def create_json(cls):
        ...
        return named_plug_versions_query_v2_faker.generate(
            use_defaults=True, use_examples=True
        )

    @classmethod
    def create_instance(cls) -> "NamedPlugVersionsQueryV2":
        ...
        if not json:
            ...
            backup_faker = JSF(
                NamedPlugVersionsQueryV2Adapter.json_schema(), allow_none_optionals=1
            )
            json = backup_faker.generate(use_defaults=True, use_examples=True)
        return NamedPlugVersionsQueryV2Adapter.validate_python(
