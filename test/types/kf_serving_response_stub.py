...
kf_serving_response_faker = JSF(
    kf_serving_response_model_schema, allow_none_optionals=1
)


class KFServingResponseStub:
    """KFServingResponse unit test stubs."""

    @classmethod
    def create_json(cls):
        """Create a dict stub instance."""
        return kf_serving_response_faker.generate(use_defaults=True, use_examples=True)

    @classmethod
    def create_instance(cls) -> "KFServingResponse":
        """Create KFServingResponse stub instance."""
        ...
        if not json:
            ...
            backup_faker = JSF(
                KFServingResponseAdapter.json_schema(), allow_none_optionals=1
            )
            json = backup_faker.generate(use_defaults=True, use_examples=True)
        return KFServingResponseAdapter.validate_python(
