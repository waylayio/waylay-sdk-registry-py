...
jobs_for_webscript_response_v2_faker = JSF(
    jobs_for_webscript_response_v2_model_schema, allow_none_optionals=1
)
...
class JobsForWebscriptResponseV2Stub:
    ...
    def create_json(cls):
        ...
        return jobs_for_webscript_response_v2_faker.generate(
            use_defaults=True, use_examples=True
        )

    @classmethod
    def create_instance(cls) -> "JobsForWebscriptResponseV2":
        ...
        if json is None:
            ...
            backup_faker = JSF(
                JobsForWebscriptResponseV2Adapter.json_schema(), allow_none_optionals=1
            )
            json = backup_faker.generate(use_defaults=True, use_examples=True)
        return JobsForWebscriptResponseV2Adapter.validate_python(
