...
class JobResponseStub:
    ...
    def create_json(cls):
        ...
        return job_response_faker.generate(use_defaults=True, use_examples=True)
    ...
    def create_instance(cls) -> "JobResponse":
        ...
        if json is None:
            ...
            backup_faker = JSF(JobResponseAdapter.json_schema(), allow_none_optionals=1)
            json = backup_faker.generate(use_defaults=True, use_examples=True)
        return JobResponseAdapter.validate_python(
