...
class DeployResultStub:
    ...
    def create_json(cls):
        ...
        return deploy_result_faker.generate(use_defaults=True, use_examples=True)
    ...
    def create_instance(cls) -> "DeployResult":
        ...
        if json is None:
            ...
            backup_faker = JSF(
                DeployResultAdapter.json_schema(), allow_none_optionals=1
            )
            json = backup_faker.generate(use_defaults=True, use_examples=True)
        return DeployResultAdapter.validate_python(
