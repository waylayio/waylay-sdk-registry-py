...
class PatchMetadataQueryStub:
    ...
    def create_json(cls):
        ...
        return patch_metadata_query_faker.generate(use_defaults=True, use_examples=True)
    ...
    def create_instance(cls) -> "PatchMetadataQuery":
        ...
        if not json:
            ...
            backup_faker = JSF(
                PatchMetadataQueryAdapter.json_schema(), allow_none_optionals=1
            )
            json = backup_faker.generate(use_defaults=True, use_examples=True)
        return PatchMetadataQueryAdapter.validate_python(
