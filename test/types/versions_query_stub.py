...
class VersionsQueryStub:
    ...
    def create_json(cls):
        ...
        return versions_query_faker.generate(use_defaults=True, use_examples=True)
    ...
    def create_instance(cls) -> "VersionsQuery":
        ...
        if not json:
            ...
            backup_faker = JSF(
                VersionsQueryAdapter.json_schema(), allow_none_optionals=1
            )
            json = backup_faker.generate(use_defaults=True, use_examples=True)
        return VersionsQueryAdapter.validate_python(
