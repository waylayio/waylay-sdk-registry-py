...
class PlugManifestStub:
    ...
    def create_json(cls):
        ...
        return plug_manifest_faker.generate(use_defaults=True, use_examples=True)
    ...
    def create_instance(cls) -> "PlugManifest":
        ...
        if json is None:
            ...
            backup_faker = JSF(
                PlugManifestAdapter.json_schema(), allow_none_optionals=1
            )
            json = backup_faker.generate(use_defaults=True, use_examples=True)
        return PlugManifestAdapter.validate_python(
