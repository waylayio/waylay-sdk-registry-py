...
class WithPagingStub:
    ...
    def create_json(cls):
        ...
        return with_paging_faker.generate(use_defaults=True, use_examples=True)
    ...
    def create_instance(cls) -> "WithPaging":
        ...
        if not json:
            ...
            backup_faker = JSF(WithPagingAdapter.json_schema(), allow_none_optionals=1)
            json = backup_faker.generate(use_defaults=True, use_examples=True)
        return WithPagingAdapter.validate_python(
