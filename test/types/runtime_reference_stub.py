...
class RuntimeReferenceStub:
    ...
    def create_json(cls):
        ...
        return runtime_reference_faker.generate(use_defaults=True, use_examples=True)
    ...
    def create_instance(cls) -> "RuntimeReference":
        ...
        if not json:
            ...
            backup_faker = JSF(
                RuntimeReferenceAdapter.json_schema(), allow_none_optionals=1
            )
            json = backup_faker.generate(use_defaults=True, use_examples=True)
        return RuntimeReferenceAdapter.validate_python(
