...
class FailedEventDataStub:
    ...
    def create_json(cls):
        ...
        return failed_event_data_faker.generate(use_defaults=True, use_examples=True)
    ...
    def create_instance(cls) -> "FailedEventData":
        ...
        if json is None:
            ...
            backup_faker = JSF(
                FailedEventDataAdapter.json_schema(), allow_none_optionals=1
            )
            json = backup_faker.generate(use_defaults=True, use_examples=True)
        return FailedEventDataAdapter.validate_python(
