...
class FunctionManifestStub:
    ...
    def create_json(cls):
        ...
        return function_manifest_faker.generate(use_defaults=True, use_examples=True)
    ...
    def create_instance(cls) -> "FunctionManifest":
        ...
        if not json:
            ...
            backup_faker = JSF(
                FunctionManifestAdapter.json_schema(), allow_none_optionals=1
            )
            json = backup_faker.generate(use_defaults=True, use_examples=True)
        return FunctionManifestAdapter.validate_python(
