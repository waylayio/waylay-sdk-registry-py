...
class AsyncDeployQueryStub:
    ...
    def create_json(cls):
        ...
        return async_deploy_query_faker.generate(use_defaults=True, use_examples=True)
    ...
    def create_instance(cls) -> "AsyncDeployQuery":
        ...
        if not json:
            ...
            backup_faker = JSF(
                AsyncDeployQueryAdapter.json_schema(), allow_none_optionals=1
            )
            json = backup_faker.generate(use_defaults=True, use_examples=True)
        return AsyncDeployQueryAdapter.validate_python(
