...
named_function_versions_query_faker = JSF(
    named_function_versions_query_model_schema, allow_none_optionals=1
)
...
class NamedFunctionVersionsQueryStub:
    ...
    def create_json(cls):
        ...
        return named_function_versions_query_faker.generate(
            use_defaults=True, use_examples=True
        )

    @classmethod
    def create_instance(cls) -> "NamedFunctionVersionsQuery":
        ...
        if not json:
            ...
            backup_faker = JSF(
                NamedFunctionVersionsQueryAdapter.json_schema(), allow_none_optionals=1
            )
            json = backup_faker.generate(use_defaults=True, use_examples=True)
        return NamedFunctionVersionsQueryAdapter.validate_python(
