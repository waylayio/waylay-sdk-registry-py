...
class RuntimeNameQueryStub:
    ...
    def create_json(cls):
        ...
        return runtime_name_query_faker.generate(use_defaults=True, use_examples=True)
    ...
    def create_instance(cls) -> "RuntimeNameQuery":
        ...
        if not json:
            ...
            backup_faker = JSF(
                RuntimeNameQueryAdapter.json_schema(), allow_none_optionals=1
            )
            json = backup_faker.generate(use_defaults=True, use_examples=True)
        return RuntimeNameQueryAdapter.validate_python(
