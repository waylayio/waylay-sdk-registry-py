...
class JobTypeScaleStub:
    ...
    def create_json(cls):
        ...
        return job_type_scale_faker.generate(use_defaults=True, use_examples=True)
    ...
    def create_instance(cls) -> "JobTypeScale":
        ...
        if json is None:
            ...
            backup_faker = JSF(
                JobTypeScaleAdapter.json_schema(), allow_none_optionals=1
            )
            json = backup_faker.generate(use_defaults=True, use_examples=True)
        return JobTypeScaleAdapter.validate_python(
