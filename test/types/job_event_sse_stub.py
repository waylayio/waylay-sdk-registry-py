...
class JobEventSSEStub:
    ...
    def create_json(cls):
        ...
        return job_event_sse_faker.generate(use_defaults=True, use_examples=True)
    ...
    def create_instance(cls) -> "JobEventSSE":
        ...
        if json is None:
            ...
            backup_faker = JSF(JobEventSSEAdapter.json_schema(), allow_none_optionals=1)
            json = backup_faker.generate(use_defaults=True, use_examples=True)
        return JobEventSSEAdapter.validate_python(
