...
class VersionsResponseV2Stub:
    ...
    def create_json(cls):
        ...
        return versions_response_v2_faker.generate(use_defaults=True, use_examples=True)
    ...
    def create_instance(cls) -> "VersionsResponseV2":
        ...
        if not json:
            ...
            backup_faker = JSF(
                VersionsResponseV2Adapter.json_schema(), allow_none_optionals=1
            )
            json = backup_faker.generate(use_defaults=True, use_examples=True)
        return VersionsResponseV2Adapter.validate_python(
