...
class PagingQueryStub:
    ...
    def create_json(cls):
        ...
        return paging_query_faker.generate(use_defaults=True, use_examples=True)

    @classmethod
    def create_instance(cls) -> "PagingQuery":
        ...
        if not json:
            ...
            backup_faker = JSF(PagingQueryAdapter.json_schema(), allow_none_optionals=1)
            json = backup_faker.generate(use_defaults=True, use_examples=True)
        return PagingQueryAdapter.validate_python(
