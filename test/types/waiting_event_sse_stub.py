...
class WaitingEventSSEStub:
    ...
    def create_json(cls):
        ...
        return waiting_event_sse_faker.generate(use_defaults=True, use_examples=True)
    ...
    def create_instance(cls) -> "WaitingEventSSE":
        ...
        if json is None:
            ...
            backup_faker = JSF(
                WaitingEventSSEAdapter.json_schema(), allow_none_optionals=1
            )
            json = backup_faker.generate(use_defaults=True, use_examples=True)
        return WaitingEventSSEAdapter.validate_python(
