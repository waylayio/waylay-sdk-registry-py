...
class WebscriptResponseStub:
    ...
    def create_json(cls):
        ...
        return webscript_response_faker.generate(use_defaults=True, use_examples=True)
    ...
    def create_instance(cls) -> "WebscriptResponse":
        ...
        if not json:
            ...
            backup_faker = JSF(
                WebscriptResponseAdapter.json_schema(), allow_none_optionals=1
            )
            json = backup_faker.generate(use_defaults=True, use_examples=True)
        return WebscriptResponseAdapter.validate_python(
