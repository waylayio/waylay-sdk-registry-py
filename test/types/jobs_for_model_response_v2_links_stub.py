...
class JobsForModelResponseV2LinksStub:
    """JobsForModelResponseV2Links unit test stubs."""

    @classmethod
    def create_json(cls):
        """Create a dict stub instance."""
        return jobs_for_model_response_v2__links_faker.generate(
            use_defaults=True, use_examples=True
        )

    @classmethod
    def create_instance(cls) -> "JobsForModelResponseV2Links":
        """Create JobsForModelResponseV2Links stub instance."""
        ...
        if json is None:
            ...
            backup_faker = JSF(
                JobsForModelResponseV2LinksAdapter.json_schema(), allow_none_optionals=1
            )
            json = backup_faker.generate(use_defaults=True, use_examples=True)
        return JobsForModelResponseV2LinksAdapter.validate_python(
