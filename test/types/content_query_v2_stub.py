...
class ContentQueryV2Stub:
    ...
    def create_json(cls):
        ...
        return content_query_v2_faker.generate(use_defaults=True, use_examples=True)
    ...
    def create_instance(cls) -> "ContentQueryV2":
        ...
        if not json:
            ...
            backup_faker = JSF(
                ContentQueryV2Adapter.json_schema(), allow_none_optionals=1
            )
            json = backup_faker.generate(use_defaults=True, use_examples=True)
        return ContentQueryV2Adapter.validate_python(
