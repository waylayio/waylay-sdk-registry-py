...
class ModelStub:
    ...
    def create_json(cls):
        ...
        return model_faker.generate(use_defaults=True, use_examples=True)
    ...
    def create_instance(cls) -> "Model":
        ...
        if json is None:
            ...
            backup_faker = JSF(ModelAdapter.json_schema(), allow_none_optionals=1)
            json = backup_faker.generate(use_defaults=True, use_examples=True)
        return ModelAdapter.validate_python(json, context={"skip_validation": True})
