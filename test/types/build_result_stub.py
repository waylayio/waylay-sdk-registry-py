...
class BuildResultStub:
    ...
    def create_json(cls):
        ...
        return build_result_faker.generate(use_defaults=True, use_examples=True)
    ...
    def create_instance(cls) -> "BuildResult":
        ...
        if json is None:
            ...
            backup_faker = JSF(BuildResultAdapter.json_schema(), allow_none_optionals=1)
            json = backup_faker.generate(use_defaults=True, use_examples=True)
        return BuildResultAdapter.validate_python(
