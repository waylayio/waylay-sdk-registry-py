...
try:
    ...
    warnings.warn(
        f"Type adapter for EntityWithLinksIPlugResponseV2 not available: {exc}"
    )
    MODELS_AVAILABLE = False

entity_with_links_i_plug_response_v2__model_schema = json.loads(r"""{
...
class EntityWithLinksIPlugResponseV2Stub:
    ...
    def create_instance(cls) -> "EntityWithLinksIPlugResponseV2":
        ...
        return EntityWithLinksIPlugResponseV2Adapter.validate_python(cls.create_json())
