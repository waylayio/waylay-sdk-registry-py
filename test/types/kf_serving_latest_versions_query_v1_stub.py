...
kf_serving_latest_versions_query_v1_faker = JSF(
    kf_serving_latest_versions_query_v1_model_schema, allow_none_optionals=1
)
...
class KFServingLatestVersionsQueryV1Stub:
    ...
    def create_json(cls):
        ...
        return kf_serving_latest_versions_query_v1_faker.generate(
            use_defaults=True, use_examples=True
        )

    @classmethod
    def create_instance(cls) -> "KFServingLatestVersionsQueryV1":
        ...
        if not json:
            ...
            backup_faker = JSF(
                KFServingLatestVersionsQueryV1Adapter.json_schema(),
                allow_none_optionals=1,
            )
            json = backup_faker.generate(use_defaults=True, use_examples=True)
        return KFServingLatestVersionsQueryV1Adapter.validate_python(
