...
class MessageResponseStub:
    ...
    def create_json(cls):
        ...
        return message_response_faker.generate(use_defaults=True, use_examples=True)
    ...
    def create_instance(cls) -> "MessageResponse":
        ...
        if not json:
            ...
            backup_faker = JSF(
                MessageResponseAdapter.json_schema(), allow_none_optionals=1
            )
            json = backup_faker.generate(use_defaults=True, use_examples=True)
        return MessageResponseAdapter.validate_python(
