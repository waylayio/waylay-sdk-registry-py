...
class DelayedEventDataStub:
    ...
    def create_json(cls):
        ...
        return delayed_event_data_faker.generate(use_defaults=True, use_examples=True)
    ...
    def create_instance(cls) -> "DelayedEventData":
        ...
        if json is None:
            ...
            backup_faker = JSF(
                DelayedEventDataAdapter.json_schema(), allow_none_optionals=1
            )
            json = backup_faker.generate(use_defaults=True, use_examples=True)
        return DelayedEventDataAdapter.validate_python(
