...
class AssetSummaryStub:
    ...
    def create_json(cls):
        ...
        return asset_summary_faker.generate(use_defaults=True, use_examples=True)
    ...
    def create_instance(cls) -> "AssetSummary":
        ...
        if not json:
            ...
            backup_faker = JSF(
                AssetSummaryAdapter.json_schema(), allow_none_optionals=1
            )
            json = backup_faker.generate(use_defaults=True, use_examples=True)
        return AssetSummaryAdapter.validate_python(
