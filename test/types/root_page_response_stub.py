...
class RootPageResponseStub:
    ...
    def create_json(cls):
        ...
        return root_page_response_faker.generate(use_defaults=True, use_examples=True)
    ...
    def create_instance(cls) -> "RootPageResponse":
        ...
        if json is None:
            ...
            backup_faker = JSF(
                RootPageResponseAdapter.json_schema(), allow_none_optionals=1
            )
            json = backup_faker.generate(use_defaults=True, use_examples=True)
        return RootPageResponseAdapter.validate_python(
