...
class LatestPlugsQueryStub:
    ...
    def create_json(cls):
        ...
        return latest_plugs_query_faker.generate(use_defaults=True, use_examples=True)
    ...
    def create_instance(cls) -> "LatestPlugsQuery":
        ...
        if not json:
            ...
            backup_faker = JSF(
                LatestPlugsQueryAdapter.json_schema(), allow_none_optionals=1
            )
            json = backup_faker.generate(use_defaults=True, use_examples=True)
        return LatestPlugsQueryAdapter.validate_python(
