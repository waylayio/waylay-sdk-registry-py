...
class UpdateDraftQueryStub:
    ...
    def create_json(cls):
        ...
        return update_draft_query_faker.generate(use_defaults=True, use_examples=True)
    ...
    def create_instance(cls) -> "UpdateDraftQuery":
        ...
        if not json:
            ...
            backup_faker = JSF(
                UpdateDraftQueryAdapter.json_schema(), allow_none_optionals=1
            )
            json = backup_faker.generate(use_defaults=True, use_examples=True)
        return UpdateDraftQueryAdapter.validate_python(
