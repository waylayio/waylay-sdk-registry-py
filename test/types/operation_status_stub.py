...
class OperationStatusStub:
    ...
    def create_json(cls):
        ...
        return operation_status_faker.generate(use_defaults=True, use_examples=True)
    ...
    def create_instance(cls) -> "OperationStatus":
        ...
        if not json:
            ...
            backup_faker = JSF(
                OperationStatusAdapter.json_schema(), allow_none_optionals=1
            )
            json = backup_faker.generate(use_defaults=True, use_examples=True)
        return OperationStatusAdapter.validate_python(
