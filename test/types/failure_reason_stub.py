...
class FailureReasonStub:
    ...
    def create_json(cls):
        ...
        return failure_reason_faker.generate(use_defaults=True, use_examples=True)
    ...
    def create_instance(cls) -> "FailureReason":
        ...
        if json is None:
            ...
            backup_faker = JSF(
                FailureReasonAdapter.json_schema(), allow_none_optionals=1
            )
            json = backup_faker.generate(use_defaults=True, use_examples=True)
        return FailureReasonAdapter.validate_python(
