...
class BatchStub:
    ...
    def create_json(cls):
        ...
        return batch_faker.generate(use_defaults=True, use_examples=True)
    ...
    def create_instance(cls) -> "Batch":
        ...
        if json is None:
            ...
            backup_faker = JSF(BatchAdapter.json_schema(), allow_none_optionals=1)
            json = backup_faker.generate(use_defaults=True, use_examples=True)
        return BatchAdapter.validate_python(json, context={"skip_validation": True})
