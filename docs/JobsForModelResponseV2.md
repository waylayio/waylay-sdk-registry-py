...
**Source:** `waylay.services.registry.models.jobs_for_model_response_v2`
...
jobs_for_model_response_v2 = JobsForModelResponseV2(jobs=..., function=..., links=...)

# Create from JSON
jobs_for_model_response_v2 = JobsForModelResponseV2.from_json(
    '{ "jobs": ..., "function": ..., "_links": ... }'
)

# Export to dictionary
jobs_for_model_response_v2_dict = jobs_for_model_response_v2.to_dict()
```
