...
> name: str,
> version: str,
> asset_role: GetAssetByRoleWebscriptsAssetRole,
...
try:
    ...
    api_response = await waylay_client.registry.webscripts.get_asset_by_role(
        "name_example",  # name | path param "name"
        "version_example",  # version | path param "version"
        waylay.services.registry.GetAssetByRoleWebscriptsAssetRole(),  # asset_role | path param "assetRole"
        # query parameters:
        query={
            "ls": False,
        },
...
**name** | **str** | path parameter `"name"` | The name of the function. | 
**version** | **str** | path parameter `"version"` | The version of the function. | 
**asset_role** | [**GetAssetByRoleWebscriptsAssetRole**](GetAssetByRoleWebscriptsAssetRole.md) | path parameter `"assetRole"` | Role name of the asset. The mapping to a concrete asset path depends on the runtime. Only asset roles with a fixed asset path for the runtime are supported. | 
**query** | [QueryParamTypes](Operation.md#req_arg_query) \| **None** | URL query parameter |  | 
**query['ls']** (dict) <br> **query.ls** (Query) | **bool** | query parameter `"ls"` | If set to &#x60;true&#x60;, the result will be a listing of the files in the asset, annotated with metadata and validation report from the asset conditions of the functions runtime. | [optional] [default False]
**headers** | [HeaderTypes](Operation.md#req_headers) | request headers |  | 
...
> name: str,
> version: str,
> asset_role: UpdateAssetByRoleWebscriptsAssetRole,
...
try:
    ...
    api_response = await waylay_client.registry.webscripts.update_asset_by_role(
        "name_example",  # name | path param "name"
        "version_example",  # version | path param "version"
        waylay.services.registry.UpdateAssetByRoleWebscriptsAssetRole(),  # asset_role | path param "assetRole"
        # query parameters:
        query={
            "showTags": "embed",
            "scaleToZero": False,
...
**name** | **str** | path parameter `"name"` | The name of the function. | 
**version** | **str** | path parameter `"version"` | The version of the function. | 
**asset_role** | [**UpdateAssetByRoleWebscriptsAssetRole**](UpdateAssetByRoleWebscriptsAssetRole.md) | path parameter `"assetRole"` | Role name of the asset. The mapping to a concrete asset path depends on the runtime. Only asset roles with a fixed asset path for the runtime are supported. | 
