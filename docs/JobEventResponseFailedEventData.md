...
**Source:** `waylay.services.registry.models.job_event_response_failed_event_data`
...
job_event_response_failed_event_data = JobEventResponseFailedEventData(
    links=..., job=..., data=..., timestamp=..., function=...
)

# Create from JSON
job_event_response_failed_event_data = JobEventResponseFailedEventData.from_json(
    '{ "_links": ..., "job": ..., "data": ..., "timestamp": ..., "function": ... }'
)

# Export to dictionary
job_event_response_failed_event_data_dict = (
    job_event_response_failed_event_data.to_dict()
)
```
