...
**Source:** `waylay.services.registry.models.latest_models_response_v2`
...
latest_models_response_v2 = LatestModelsResponseV2(
    embedded=..., limit=..., count=..., page=..., entities=...
)

# Create from JSON
latest_models_response_v2 = LatestModelsResponseV2.from_json(
    '{ "_embedded": ..., "limit": ..., "count": ..., "page": ..., "entities": ... }'
)

# Export to dictionary
latest_models_response_v2_dict = latest_models_response_v2.to_dict()
```
