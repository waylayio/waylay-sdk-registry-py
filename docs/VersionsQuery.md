...
versions_query_instance = VersionsQuery.from_json(json)
# print the JSON string representation of the object
print VersionsQuery.to_json()

# convert the object into a dict
versions_query_dict = versions_query_instance.to_dict()
# create an instance of VersionsQuery from a dict
versions_query_form_dict = versions_query.from_dict(versions_query_dict)
```
