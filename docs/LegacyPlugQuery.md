...
legacy_plug_query_instance = LegacyPlugQuery.from_json(json)
# print the JSON string representation of the object
print LegacyPlugQuery.to_json()

# convert the object into a dict
legacy_plug_query_dict = legacy_plug_query_instance.to_dict()
# create an instance of LegacyPlugQuery from a dict
legacy_plug_query_form_dict = legacy_plug_query.from_dict(legacy_plug_query_dict)
```
