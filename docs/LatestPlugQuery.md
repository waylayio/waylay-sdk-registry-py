...
latest_plug_query_instance = LatestPlugQuery.from_json(json)
# print the JSON string representation of the object
print LatestPlugQuery.to_json()

# convert the object into a dict
latest_plug_query_dict = latest_plug_query_instance.to_dict()
# create an instance of LatestPlugQuery from a dict
latest_plug_query_form_dict = latest_plug_query.from_dict(latest_plug_query_dict)
```
