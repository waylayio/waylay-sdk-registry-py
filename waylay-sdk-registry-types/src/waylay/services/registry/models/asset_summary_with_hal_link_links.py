...
class AssetSummaryWithHALLinkLinks(BaseModel):
    ...
    def to_dict(self) -> dict[str, Any]:
        """Convert the AssetSummaryWithHALLinkLinks instance to dict."""
        return self.model_dump(by_alias=True, exclude_unset=True, exclude_none=True)

    def to_json(self) -> str:
        """Convert the AssetSummaryWithHALLinkLinks instance to a JSON-encoded string."""
    ...
    def from_dict(cls, obj: dict) -> Self:
        """Create a AssetSummaryWithHALLinkLinks instance from a dict."""
        return cls.model_validate(obj)

    @classmethod
    def from_json(cls, json_data: str | bytes | bytearray) -> Self:
        """Create a AssetSummaryWithHALLinkLinks instance from a JSON-encoded string."""
