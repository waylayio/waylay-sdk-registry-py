...
class PlugMeta(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["author", "description", "iconURL", "category", "documentationURL", "tags", "friendlyName", "documentation"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "documentation": Documentation.from_dict(obj.get("documentation")) if obj.get("documentation") is not None else None    # type: ignore
        })
        return _obj
