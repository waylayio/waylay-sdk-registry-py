...
ASSETCONDITIONCONTENTTYPE_ANY_OF_SCHEMAS = ["List[str]", "str"]


class AssetConditionContentType(BaseModel):
    ...
    any_of_schemas: List[str] = ASSETCONDITIONCONTENTTYPE_ANY_OF_SCHEMAS
    ...
    def __init__(self, *args, **kwargs) -> None:
        """Create a AssetConditionContentType model instance."""
        if args:
            if len(args) > 1:
    ...
    def actual_instance_must_validate_anyof(cls, v):
        ...
        instance = AssetConditionContentType.model_construct()
        error_messages = []
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when setting the actual_instance in AssetConditionContentType with anyOf schemas: List[str], str. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when deserializing the JSON string into AssetConditionContentType with anyOf schemas: List[str], str. Details: " + ", ".join(error_messages))
        else:
            return instance
