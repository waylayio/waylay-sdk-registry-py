...
class CreateWebscriptAsyncResponse(BaseModel):
    """Successful Response."""

    message: StrictStr
    links: JobHALLinks = Field(alias="_links")
    entity: WebscriptManifest
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "entity": WebscriptManifest.from_dict(obj.get("entity")) if obj.get("entity") is not None else None    # type: ignore
        })
        return _obj
