...
class WebscriptResponseV2(BaseModel):
    """WebscriptResponseV2."""
    ...
    __properties: ClassVar[List[str]] = ["createdBy", "createdAt", "updatedBy", "updatedAt", "updates", "status", "failureReason", "runtime", "deprecated", "draft", "webscript", "secret"]
