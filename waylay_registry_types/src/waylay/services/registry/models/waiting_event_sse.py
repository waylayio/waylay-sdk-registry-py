...
from ..models.job_event_response_waiting_event_data import JobEventResponseWaitingEventData
...
class WaitingEventSSE(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "event": obj.get("event"),
            "data": JobEventResponseWaitingEventData.from_dict(obj.get("data")) if obj.get("data") is not None else None    # type: ignore
        })
        return _obj
