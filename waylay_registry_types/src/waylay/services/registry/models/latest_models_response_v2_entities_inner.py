...
class LatestModelsResponseV2EntitiesInner(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["_links", "createdBy", "createdAt", "updatedBy", "updatedAt", "updates", "status", "failureReason", "runtime", "deprecated", "draft", "model"]
