...
from ..models.latest_plugs_response_v2_entities_inner import LatestPlugsResponseV2EntitiesInner
...
class LatestPlugsResponseV2(BaseModel):
    ...
    entities: List[LatestPlugsResponseV2EntitiesInner] = Field(description="The specification and deployment status of the queried functions")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "count": obj.get("count"),
            "page": obj.get("page"),
            "entities": [LatestPlugsResponseV2EntitiesInner.from_dict(_item) for _item in obj.get("entities")] if obj.get("entities") is not None else None  # type: ignore
        })
        return _obj
