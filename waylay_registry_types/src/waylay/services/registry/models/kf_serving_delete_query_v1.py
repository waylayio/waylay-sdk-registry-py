...
class KFServingDeleteQueryV1(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["async", "limit", "page", "includeDraft", "includeDeprecated", "version", "status", "runtimeVersion", "createdBy", "updatedBy", "createdBefore", "createdAfter", "updatedBefore", "updatedAfter", "name", "archiveFormat", "runtime"]
