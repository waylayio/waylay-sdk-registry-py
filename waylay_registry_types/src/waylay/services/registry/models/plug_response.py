...
class PlugResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["deploy", "name", "version", "runtime", "runtimeVersion", "metadata", "createdBy", "createdAt", "updatedBy", "updatedAt", "status", "failureReason", "_links", "isDeprecated"]
