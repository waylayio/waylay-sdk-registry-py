...
class AnyJobStatus(BaseModel):
    ...
    def actual_instance_must_validate_anyof(cls, v):
        ...
        instance = AnyJobStatus.model_construct()  # noqa: F841
        error_messages = []
        # validate data type: BuildJobStatus
        if not isinstance(v, BuildJobStatus):
            error_messages.append(
                f"Error! Input type `{type(v)}` is not `BuildJobStatus`"
            )
        else:
            return v
        ...
        if not isinstance(v, DeployJobStatus):
            error_messages.append(
                f"Error! Input type `{type(v)}` is not `DeployJobStatus`"
            )
        else:
            return v
        ...
        if not isinstance(v, VerifyJobStatus):
            error_messages.append(
                f"Error! Input type `{type(v)}` is not `VerifyJobStatus`"
            )
        else:
            return v
        ...
        if not isinstance(v, UndeployJobStatus):
            error_messages.append(
                f"Error! Input type `{type(v)}` is not `UndeployJobStatus`"
            )
        else:
            return v
        ...
        if not isinstance(v, ScaleJobStatus):
            error_messages.append(
                f"Error! Input type `{type(v)}` is not `ScaleJobStatus`"
            )
        else:
            return v
        ...
        if not isinstance(v, BatchJobStatus):
            error_messages.append(
                f"Error! Input type `{type(v)}` is not `BatchJobStatus`"
            )
        else:
            return v
        ...
        if error_messages:
            # no match
            raise ValueError(
                "No match found when setting the actual_instance in AnyJobStatus with anyOf schemas: BatchJobStatus, BuildJobStatus, DeployJobStatus, ScaleJobStatus, UndeployJobStatus, VerifyJobStatus. Details: "
                + ", ".join(error_messages)
            )
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if error_messages:
            # no match
            raise ValueError(
                "No match found when deserializing the JSON string into AnyJobStatus with anyOf schemas: BatchJobStatus, BuildJobStatus, DeployJobStatus, ScaleJobStatus, UndeployJobStatus, VerifyJobStatus. Details: "
                + ", ".join(error_messages)
            )
        else:
            return instance
