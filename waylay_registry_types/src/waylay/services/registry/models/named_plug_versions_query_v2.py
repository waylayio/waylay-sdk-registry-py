...
class NamedPlugVersionsQueryV2(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["tags", "limit", "page", "deprecated", "draft", "version", "status", "runtimeVersion", "createdBy", "updatedBy", "createdBefore", "createdAfter", "updatedBefore", "updatedAfter", "archiveFormat", "runtime"]
