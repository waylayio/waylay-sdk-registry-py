...
from ..models.job_event_response_failed_event_data import JobEventResponseFailedEventData
...
class FailedEventSSE(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "event": obj.get("event"),
            "data": JobEventResponseFailedEventData.from_dict(obj.get("data")) if obj.get("data") is not None else None    # type: ignore
        })
        return _obj
