...
class NamedFunctionVersionsQuery(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["limit", "page", "deprecated", "draft", "version", "status", "runtimeVersion", "createdBy", "updatedBy", "createdBefore", "createdAfter", "updatedBefore", "updatedAfter", "archiveFormat", "runtime"]
