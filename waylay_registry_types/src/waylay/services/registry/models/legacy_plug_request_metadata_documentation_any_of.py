...
class LegacyPlugRequestMetadataDocumentationAnyOf(BaseModel):
    ...
    supported_states: Optional[List[DocumentationProperty]] = Field(default=None, alias="supportedStates")
    configuration: Optional[List[DocumentationProperty]] = None
    raw_data: Optional[List[DocumentationProperty]] = Field(default=None, alias="rawData")
