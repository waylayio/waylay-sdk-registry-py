...
class KFServingLatestVersionsQueryV1(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["limit", "page", "includeDraft", "includeDeprecated", "version", "status", "runtimeVersion", "createdBy", "updatedBy", "createdBefore", "createdAfter", "updatedBefore", "updatedAfter", "name", "archiveFormat", "runtime"]
