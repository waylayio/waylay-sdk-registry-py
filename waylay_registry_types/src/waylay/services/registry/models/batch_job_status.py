...
class BatchJobStatus(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "request": BatchArgs.from_dict(obj.get("request")) if obj.get("request") is not None else None,    # type: ignore
            "result": BatchResult.from_dict(obj.get("result")) if obj.get("result") is not None else None,    # type: ignore
