...
class AltEmbeddedVersionIPlugResponseV2(BaseModel):
    """Embedded representations of the _latest_ draft/published versions.."""

    draft: Optional[PlugResponseV2] = None
    published: Optional[PlugResponseV2] = None
    ...
    def to_dict(self) -> dict[str, Any]:
        """Convert the AltEmbeddedVersionIPlugResponseV2 instance to dict."""
        return self.model_dump(by_alias=True, exclude_unset=True, exclude_none=True)

    def to_json(self) -> str:
        """Convert the AltEmbeddedVersionIPlugResponseV2 instance to a JSON-encoded string."""
    ...
    def from_dict(cls, obj: dict) -> Self:
        """Create a AltEmbeddedVersionIPlugResponseV2 instance from a dict."""
        return cls.model_validate(obj)

    @classmethod
    def from_json(cls, json_data: Union[str, bytes, bytearray]) -> Self:
        """Create a AltEmbeddedVersionIPlugResponseV2 instance from a JSON-encoded string."""
