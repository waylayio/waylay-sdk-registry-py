...
class CreateKFServingAsyncResponse(BaseModel):
    """Model Deployment Initiated."""

    message: StrictStr
    links: JobHALLinks = Field(alias="_links")
    entity: KFServingManifest
    __properties: ClassVar[List[str]] = ["message", "_links", "entity"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "entity": KFServingManifest.from_dict(obj.get("entity")) if obj.get("entity") is not None else None    # type: ignore
        })
        return _obj
