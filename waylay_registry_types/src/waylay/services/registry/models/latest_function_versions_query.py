...
class LatestFunctionVersionsQuery(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["limit", "page", "includeDraft", "includeDeprecated", "deprecated", "draft", "nameVersion", "version", "status", "runtimeVersion", "createdBy", "updatedBy", "createdBefore", "createdAfter", "updatedBefore", "updatedAfter", "name", "archiveFormat", "runtime", "latest"]
