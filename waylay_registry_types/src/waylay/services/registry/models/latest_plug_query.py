...
class LatestPlugQuery(BaseModel):
    ...
    type: PlugType
    __properties: ClassVar[List[str]] = ["tags", "limit", "page", "includeDraft", "includeDeprecated", "version", "status", "runtimeVersion", "createdBy", "updatedBy", "createdBefore", "createdAfter", "updatedBefore", "updatedAfter", "name", "archiveFormat", "runtime", "type"]
