...
class WebscriptManifest(BaseModel):
    ...
    private: StrictBool = Field(description="If <code>true</code> this webscript will require authentication.")
    allow_hmac: StrictBool = Field(description="If <code>true</code> this webscript will support authentication with a <em>HMAC</em> key, available as the <code>secret</code> attribute of the deployed webscript entity.", alias="allowHmac")
    __properties: ClassVar[List[str]] = ["deploy", "name", "version", "runtime", "runtimeVersion", "metadata", "private", "allowHmac"]
