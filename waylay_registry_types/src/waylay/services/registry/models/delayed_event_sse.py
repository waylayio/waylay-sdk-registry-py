...
from ..models.job_event_response_delayed_event_data import JobEventResponseDelayedEventData
...
class DelayedEventSSE(BaseModel):
    ...
    def event_validate_enum(cls, value):
        """Validate the enum."""
        if value not in ('delayed'):
            raise ValueError("must be one of enum values ('delayed')")
        return value
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "event": obj.get("event"),
            "data": JobEventResponseDelayedEventData.from_dict(obj.get("data")) if obj.get("data") is not None else None    # type: ignore
        })
        return _obj
