...
STATUSFILTER_ANY_OF_SCHEMAS = ["StatusAny", "StatusInclude", "str"]
...
class StatusFilter(BaseModel):
    ...
    if TYPE_CHECKING:
        actual_instance: Optional[Union[StatusAny, StatusInclude, str]] = None
    else:
        actual_instance: Any = None
    any_of_schemas: List[str] = STATUSFILTER_ANY_OF_SCHEMAS
    ...
    def actual_instance_must_validate_anyof(cls, v):
        ...
        # validate data type: StatusAny
        if not isinstance(v, StatusAny):
            error_messages.append(f"Error! Input type `{type(v)}` is not `StatusAny`")
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        # anyof_schema_1_validator: Optional[StatusInclude] = None
        try:
            instance.actual_instance = StatusInclude.from_json(json_str)
            return instance
        except (ValidationError, ValueError) as e:
            error_messages.append(str(e))
        ...
        # anyof_schema_3_validator: Optional[StatusAny] = None
        try:
            instance.actual_instance = StatusAny.from_json(json_str)
            return instance
        except (ValidationError, ValueError) as e:
            error_messages.append(str(e))
