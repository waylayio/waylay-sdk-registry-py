...
if TYPE_CHECKING:
    ...
    from waylay.services.registry.queries.plug_functions_api import GetLatestVersionQuery
...
class PlugFunctionsApi:
    ...
    def __init__(self, api_client: ApiClient) -> None:
        """Create a PlugFunctionsApi instance."""
    ...
    async def patch_interface(
        ...
        *,
        ...
        _request_params = self._patch_interface_serialize(
            name=name,
            version=version,
            body=body,
            files=None,
