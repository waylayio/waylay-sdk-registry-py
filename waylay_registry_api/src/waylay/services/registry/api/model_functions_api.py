...
try:
    ...
    if not TYPE_CHECKING:
        ...
        PostModelJobSyncResponseV2 = Any
        PostModelJobAsyncResponseV2 = Any
        ...
        RebuildModelSyncResponseV2 = Any
        RebuildModelAsyncResponseV2 = Any
...
class ModelFunctionsApi(WithApiClient):
    ...
    async def create(
        ...
        *,
        ...
        headers: Optional[HeaderTypes] = None,
        **kwargs,
    ) -> Union[PostModelJobSyncResponseV2, Response, Any]:
        """Create Model.
        ...
        response_types_map: Dict[str, Optional[Union[str, Any]]] = {
            "201": PostModelJobSyncResponseV2 if not select_path else Any,
            "202": PostModelJobAsyncResponseV2 if not select_path else Any,
        }
    ...
    async def get_latest(
        ...
        *,
        ...
        headers: Optional[HeaderTypes] = None,
        **kwargs,
    ) -> Union[GetModelResponseV2, Response, Any]:
        ...
        if raw_response:
            return response
        response_types_map: Dict[str, Optional[Union[str, Any]]] = {
            "200": GetModelResponseV2 if not select_path else Any,
        }
        stream = send_args.get("stream", False)
        return self.api_client.response_deserialize(
            response, response_types_map, select_path, stream=stream
    ...
    async def jobs(
        ...
        *,
        ...
        headers: Optional[HeaderTypes] = None,
        **kwargs,
    ) -> Union[JobsForModelResponseV2, Response, Any]:
        """List Model Jobs.
        ...
        if raw_response:
            return response
        response_types_map: Dict[str, Optional[Union[str, Any]]] = {
            "200": JobsForModelResponseV2 if not select_path else Any,
        }
        stream = send_args.get("stream", False)
        return self.api_client.response_deserialize(
            response, response_types_map, select_path, stream=stream
    ...
    async def list(
        ...
        *,
        ...
        headers: Optional[HeaderTypes] = None,
        **kwargs,
    ) -> Union[LatestModelsResponseV2, Response, Any]:
        """List Models.
        ...
        if raw_response:
            return response
        response_types_map: Dict[str, Optional[Union[str, Any]]] = {
            "200": LatestModelsResponseV2 if not select_path else Any,
        }
        stream = send_args.get("stream", False)
        return self.api_client.response_deserialize(
            response, response_types_map, select_path, stream=stream
    ...
    async def list_versions(
        ...
        *,
        ...
        headers: Optional[HeaderTypes] = None,
        **kwargs,
    ) -> Union[ModelVersionsResponseV2, Response, Any]:
        """List Model Versions.
        ...
        if raw_response:
            return response
        response_types_map: Dict[str, Optional[Union[str, Any]]] = {
            "200": ModelVersionsResponseV2 if not select_path else Any,
        }
        stream = send_args.get("stream", False)
        return self.api_client.response_deserialize(
            response, response_types_map, select_path, stream=stream
    ...
    async def rebuild(
        ...
        *,
        ...
        headers: Optional[HeaderTypes] = None,
        **kwargs,
    ) -> Union[RebuildModelSyncResponseV2, Response, Any]:
        """Rebuild Model.
        ...
        if raw_response:
            return response
        response_types_map: Dict[str, Optional[Union[str, Any]]] = {
            "200": RebuildModelSyncResponseV2 if not select_path else Any,
            "202": RebuildModelAsyncResponseV2 if not select_path else Any,
        }
        stream = send_args.get("stream", False)
        return self.api_client.response_deserialize(
            response, response_types_map, select_path, stream=stream
    ...
    async def verify(
        ...
        *,
        ...
        headers: Optional[HeaderTypes] = None,
        **kwargs,
    ) -> Union[VerifyModelSyncResponseV2, Response, Any]:
        ...
        if raw_response:
            return response
        response_types_map: Dict[str, Optional[Union[str, Any]]] = {
            "200": VerifyModelSyncResponseV2 if not select_path else Any,
            "202": PostModelJobAsyncResponseV2 if not select_path else Any,
        }
        stream = send_args.get("stream", False)
        return self.api_client.response_deserialize(
