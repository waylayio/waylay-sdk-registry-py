...
try:
    ...
    if not TYPE_CHECKING:
        ...
        PostWebscriptJobSyncResponseV2 = Any

        PostWebscriptJobSyncResponseV2 = Any
        PostWebscriptJobAsyncResponseV2 = Any
        ...
        RebuildWebscriptSyncResponseV2 = Any

        RebuildWebscriptSyncResponseV2 = Any
        RebuildWebscriptAsyncResponseV2 = Any
...
class WebscriptFunctionsApi(WithApiClient):
    ...
    async def create(
        ...
        *,
        ...
        headers: Optional[HeaderTypes] = None,
        **kwargs,
    ) -> Union[PostWebscriptJobSyncResponseV2, Response, Any]:
        ...
        :param body: The assets for a <em>webscript</em> function can be provided as either   <ul>     <li>a single <em>tar</em> archive (optionally compressed), with one of the content types      <code>application/octet-stream</code>, <code>application/tar+gzip</code>, <code>application/x-gzip</code>, <code>application/x-tar</code>, <code>application/gzip</code></li>     <li>separate files in a <code>multipart/form-data</code> request</li>   </ul>      The required <code>webscript.json</code> json file contains the function metadata,   and must have a <code>runtime</code> attribute that is one of the supported <em>runtime</em>s    (see <code>GET /registry/v2/runtimes?functionType=webscripts</code>).    For each <em>runtime</em> other files will be required or supported.
        ...
        response_types_map: Dict[str, Optional[Union[str, Any]]] = {
            "201": PostWebscriptJobSyncResponseV2 if not select_path else Any,
            "202": PostWebscriptJobAsyncResponseV2 if not select_path else Any,
        }
    ...
    async def get_latest(
        ...
        *,
        ...
        headers: Optional[HeaderTypes] = None,
        **kwargs,
    ) -> Union[GetWebscriptResponseV2, Response, Any]:
        ...
        if raw_response:
            return response
        response_types_map: Dict[str, Optional[Union[str, Any]]] = {
            "200": GetWebscriptResponseV2 if not select_path else Any,
        }
        stream = send_args.get("stream", False)
        return self.api_client.response_deserialize(
            response, response_types_map, select_path, stream=stream
    ...
    async def jobs(
        ...
        *,
        ...
        headers: Optional[HeaderTypes] = None,
        **kwargs,
    ) -> Union[JobsForWebscriptResponseV2, Response, Any]:
        """List Webscript Jobs.
        ...
        if raw_response:
            return response
        response_types_map: Dict[str, Optional[Union[str, Any]]] = {
            "200": JobsForWebscriptResponseV2 if not select_path else Any,
        }
        stream = send_args.get("stream", False)
        return self.api_client.response_deserialize(
            response, response_types_map, select_path, stream=stream
    ...
    async def list_versions(
        ...
        *,
        ...
        headers: Optional[HeaderTypes] = None,
        **kwargs,
    ) -> Union[WebscriptVersionsResponseV2, Response, Any]:
        ...
        if raw_response:
            return response
        response_types_map: Dict[str, Optional[Union[str, Any]]] = {
            "200": WebscriptVersionsResponseV2 if not select_path else Any,
        }
        stream = send_args.get("stream", False)
        return self.api_client.response_deserialize(
            response, response_types_map, select_path, stream=stream
    ...
    async def list(
        ...
        *,
        ...
        headers: Optional[HeaderTypes] = None,
        **kwargs,
    ) -> Union[LatestWebscriptsResponseV2, Response, Any]:
        """List Webscripts.
        ...
        if raw_response:
            return response
        response_types_map: Dict[str, Optional[Union[str, Any]]] = {
            "200": LatestWebscriptsResponseV2 if not select_path else Any,
        }
        stream = send_args.get("stream", False)
        return self.api_client.response_deserialize(
            response, response_types_map, select_path, stream=stream
    ...
    async def rebuild(
        ...
        *,
        ...
        headers: Optional[HeaderTypes] = None,
        **kwargs,
    ) -> Union[RebuildWebscriptSyncResponseV2, Response, Any]:
        """Rebuild Webscript.
        ...
        if raw_response:
            return response
        response_types_map: Dict[str, Optional[Union[str, Any]]] = {
            "200": RebuildWebscriptSyncResponseV2 if not select_path else Any,
            "202": RebuildWebscriptAsyncResponseV2 if not select_path else Any,
        }
        stream = send_args.get("stream", False)
        return self.api_client.response_deserialize(
            response, response_types_map, select_path, stream=stream
    ...
    async def verify(
        ...
        *,
        ...
        headers: Optional[HeaderTypes] = None,
        **kwargs,
    ) -> Union[VerifyWebscriptSyncResponseV2, Response, Any]:
        ...
        if raw_response:
            return response
        response_types_map: Dict[str, Optional[Union[str, Any]]] = {
            "200": VerifyWebscriptSyncResponseV2 if not select_path else Any,
            "202": PostWebscriptJobAsyncResponseV2 if not select_path else Any,
        }
        stream = send_args.get("stream", False)
        return self.api_client.response_deserialize(
